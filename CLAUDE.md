...
**Now starting Phase 4** (`phases/phase-4-polish-release.md`): polish & release — clipboard fallback pipeline (4.1), animation/feel pass (4.2), resilience & performance (4.3), packaging & notarized distribution (4.4), launch checklist (4.5). Stage 4.4 (Developer ID signing/notarization) will need real credentials this environment doesn't have — flag that stage rather than faking it.
