...
// GRDB+SQLCipher: applied per GRDB's own Package.swift instructions
// (Stage 5.3 SQLCipher feasibility spike, WriterFlow phases/phase-5-v2-cloud-foundation.md).
// Vendored from groue/GRDB.swift v7.11.1 — re-apply this same patch when bumping the
// vendored version; upstream tracking/security-update owner: whoever owns Stage 5.3.
